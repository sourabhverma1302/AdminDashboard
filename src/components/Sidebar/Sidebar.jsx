...
const Sidebar = ({ isOpen, toggleSidebar, isDarkMode }) => {
  ...
  return (
    <div className={`fixed inset-y-0 left-0 w-64 px-2 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-200 text-gray-900'} transform transition duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-64'} z-40`}>
