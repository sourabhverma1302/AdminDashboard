...
const Sidebar = ({ isOpen, toggleSidebar, isDarkMode }) => {
  ...
  return (
    <div className={`fixed inset-y-0 left-0 px-2 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-200 text-gray-900'} ${isOpen?'w-[15.6%]':'w-[0%]'} transform transition duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-64'}`}>
